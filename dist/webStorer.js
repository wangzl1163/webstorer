/*!
 * @license :webstorer - V0.6.1 - 19/04/2021
...
/* harmony import */ var jsstore__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(87);
...
/* harmony import */ var sqlweb__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(86);
...
var getWorkerPath = function getWorkerPath() {
  ...
  if (isDev) {
    ...
    return __webpack_require__(178); // return jsStoreWorker
  } else {
    // return prod build when env is production
    // eslint-disable-next-line import/no-webpack-loader-syntax
    return __webpack_require__(179); // return jsStoreWorkerMin
  }
};
